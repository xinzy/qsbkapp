 ...
 */
public class ContentFragment extends AbsBaseFragment implements SwipeRefreshLayout.OnRefreshListener, AbsListView.OnScrollListener, IContentView, MainActivity.ContentFragmentCallback, ContentItemView.OnItemViewListener
{
