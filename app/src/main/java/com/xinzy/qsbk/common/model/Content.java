...
public class Content implements Parcelable
{
	...
	public Content(JSONObject json)
	{
		...
		picSize = ImageSize.parse(json.optJSONArray("pic_size"));
	...
	public void setPicSize(ImageSize picSize)
	{
	...
	public void writeToParcel(Parcel dest, int flags)
	{
		...
		dest.writeParcelable(this.picSize, flags);
	...
	protected Content(Parcel in)
	{
		...
		this.picSize = in.readParcelable(ImageSize.class.getClassLoader());
