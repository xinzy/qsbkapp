package com.xinzy.qsbk.common.widget;
...
/**
 * Created by xinzy on 16/5/29.
 */
public class PraiseView extends PopupWindow
{
	public static int    DISTANCE     = 60;   // 默认移动距离
	public static int    FROM_Y_DELTA = 0; // Y轴移动起始偏移量
	public static int    TO_Y_DELTA   = DISTANCE; // Y轴移动最终偏移量
	public static float  FROM_ALPHA   = 1.0f;    // 起始时透明度
	public static float  TO_ALPHA     = 0.0f;  // 结束时透明度
	public static int    DURATION     = 800; // 动画时长
	public static String TEXT         = ""; // 默认文本
	public static int    TEXT_SIZE    = 16; // 默认文本字体大小
	public static int    TEXT_COLOR   = Color.BLACK;   // 默认文本字体颜色
