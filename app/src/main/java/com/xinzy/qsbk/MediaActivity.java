...
public class MediaActivity extends AppCompatActivity implements SurfaceHolder.Callback, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener, MediaPlayer.OnCompletionListener, View.OnClickListener, InternalMediaPlayer.OnStatusChangeListener, SeekBar.OnSeekBarChangeListener
{
	...
	{
		if (mMediaPlayer == null || mMediaPlayer.getVideoHeight() == 0 || mMediaPlayer.getVideoWidth() == 0)
			return;
